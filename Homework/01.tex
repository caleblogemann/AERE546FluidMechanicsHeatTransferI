...
\begin{enumerate}
  ...
  \item[\#2]
    \item[(a)] % Done
      ...
      \lstinputlisting[language=MATLAB, lastline=71]{H01.m}
      ...
      \begin{center}
        ...
        \includegraphics[scale=.6]{Figures/01_09.png}
        \includegraphics[scale=.6]{Figures/01_10.png}
      \end{center}
    ...
    \item[(b)]
      ...
      We now use the same RK2 method shown in part (a), but with the RHS given
      above.
